...
Public Class T017_3
    ...
    '--ファンクションキー処理              ----------
    '------------------------------------------------
    Private Sub T017_3_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub DataGridView1_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentDoubleClick
        ...
        '値を取得
        Dim strShipmentNO As String = DataGridView1.Item(0, intRow).Value.ToString.Trim
        Dim strShipmentName As String = DataGridView1.Item(1, intRow).Value.ToString.Trim
        '値を転送
        Dim frm As T017 = CType(Me.Owner, T017)
        frm.txtShipmentMSNo.Text = strShipmentNO
        frm.lblShipmentMSName.Text = strShipmentName
        '終了処理
        Me.Close()
