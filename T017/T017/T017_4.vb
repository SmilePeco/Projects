...
Public Class T017_4
    ...
    '--ファンクションキー処理              ----------
    '------------------------------------------------
    Private Sub T017_4_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub DataGridView1_CellMouseDoubleClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles DataGridView1.CellMouseDoubleClick
        ...
        frm.txtItemMSNo.Text = strItemNO
        frm.lblItemMSName.Text = strItemName
        '終了処理
        Me.Close()
