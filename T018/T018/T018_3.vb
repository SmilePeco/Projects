...
Public Class T018_3
    ...
    '--ファンクションキー処理              ----------
    '------------------------------------------------
    Private Sub T018_3_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub DataGridView1_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentDoubleClick
        ...
        '値を取得
        Dim strWorkProcessNO As String = DataGridView1.Item(0, intRow).Value.ToString.Trim
        Dim strWorkProcessName As String = DataGridView1.Item(1, intRow).Value.ToString.Trim
        '値を転送
    ...
    Public Function fMainSearch()
        ...
        Try
            ...
            If txtItemNo.Text.Trim <> "" Then
                strSQL &= "WHERE "
                strSQL &= " 作業工程NO = '" & txtItemNo.Text.Trim & "' "
            End If
