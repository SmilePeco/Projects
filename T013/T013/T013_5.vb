...
Public Class T013_5
    ...
    '--KeyDown処理                         ----------
    '------------------------------------------------
    Private Sub T013_5_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub DataGridView1_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentDoubleClick
        ...
        '値を取得
        Dim strShipmentNo As String = DataGridView1.Item(0, intRow).Value
        Dim strShipmentName As String = DataGridView1.Item(1, intRow).Value
        '元フォームに転送
        Dim frm As T013 = CType(Me.Owner, T013)
        frm.txtMainShipmentMSNO.Text = strShipmentNo
        frm.lblMainShipmentMSName.Text = strShipmentName
        Me.Close()
    ...
    Public Function fMainSearch()
        ...
        Try
            ...
            Else
                MessageBox.Show("入力した出荷先NOは存在しません。" & vbCrLf & "確認してください。", "エラー", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Return False
