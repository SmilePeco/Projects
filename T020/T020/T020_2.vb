...
Public Class T020_2
    ...
    '--ファンクションキー押下処理          ----------
    '------------------------------------------------
    Private Sub T020_2_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub DataGridView1_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentDoubleClick
        ...
        '値の転送
        Dim frm As T020 = CType(Me.Owner, T020)
        frm.txtShipmentNo.Text = strShipmentNO
        '終了処理
        Me.Close()
