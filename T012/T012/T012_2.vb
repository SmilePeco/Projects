...
Public Class T012_2
    ...
    '--KeyDown処理                         ----------
    '------------------------------------------------
    Private Sub T012_2_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub DataGridView1_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentDoubleClick
        ...
        '元フォームに転送
        Dim frm As T012 = CType(Me.Owner, T012)
        frm.txtShipmentMSNo.Text = strOrderNo
        frm.lblShipmentMSName.Text = strOrderName
        Me.Close()
